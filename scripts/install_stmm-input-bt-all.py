...
def main():
	...
	print("== install stmm-input-bttest =========" + sInfo + "==")
	os.chdir("stmm-input-bttest/scripts")
	subprocess.check_call("./install_stmm-input-bttest.py {} {} {}".format(sBuildType, sDestDir, sSudo).split())
	os.chdir("../..")
