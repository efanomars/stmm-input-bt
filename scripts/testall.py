...
def testAll(sBuildType, sDestDir, sSudo, bBuildStatic, bSanitize):
	...
	subprocess.check_call("./scripts/uninstall_stmm-input-bt-all.py -r -y --destdir {}  {}".format(sDestDir, sSudo).split())

	subprocess.check_call("./scripts/install_stmm-input-bt-all.py -b {}  -t On  -d On --docs-to-log  --destdir {}  {} {} {}"\
