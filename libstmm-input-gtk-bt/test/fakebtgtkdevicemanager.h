...
#define STMI_TESTING_FAKE_BT_GTK_DEVICE_MANAGER_H
...
{
public:
	static shared_ptr<FakeBtGtkDeviceManager> create(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClasses) noexcept
	{
...
//std::cout << "FakeBtGtkDeviceManager::create 1" << '\n';
	...
	FakeBtGtkDeviceManager(bool bEnableEventClasses, const std::vector<Event::Class>& aEnDisableEventClasses) noexcept
...
//std::cout << "FakeBtGtkDeviceManager::makeWindowActive 0" << '\n';
	...
	Bt::FakeGtkWindowDataFactory* getFactory() noexcept { return m_p0Factory; }
	Bt::FakeGtkBackend* getBackend() noexcept { return m_p0Backend; }
protected:
...
#endif /* STMI_TESTING_FAKE_BT_GTK_DEVICE_MANAGER_H */
